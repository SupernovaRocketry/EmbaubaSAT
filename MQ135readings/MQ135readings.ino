...
#define DEFAULT_C02 415 //default ppm of CO2 for calibration
...
void loop() {
  ...
  float CO2 = MQ135.readSensor(false); // Sensor will read PPM concentration using the model, a and b values set previously or from the setup
